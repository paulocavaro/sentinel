...
/* A feature with no photograph. Six of the fifty items published so far arrived
   without a usable image, so this is an ordinary day rather than an exception,
   and the card is
