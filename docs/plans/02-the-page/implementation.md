...
- [x] **Step 1 — Drop `.toggle` from the generators.** Both references render a
...
- [x] **Step 2 — Add the rules the references promise and do not contain:**
...
- [x] **Step 3 — Fix `.day.is-off`.** `opacity: 0.45` on `--machine` lands near
...
- [x] **Step 4 — Generate `design-refs/day.html`** from `2026-08-08.json`. A
...
- [x] **Step 5 — Update `.loop/config.md`:** `day` points at `/day/2026-08-08`
  and `design-refs/day.html`; `states` gains the route `/states`.
- [x] **Step 6 — Commit:** `fix(02): make the design references verifiable`
